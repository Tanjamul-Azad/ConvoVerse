...
const Login: React.FC = () => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-[#fafafa] relative overflow-hidden p-6">
            {/* Background Elements */}
            ...
            <div className="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vw] bg-brand-primary/10 rounded-full blur-[120px] animate-float"></div>
            <div className="absolute bottom-[-20%] right-[-10%] w-[70vw] h-[70vw] bg-brand-secondary/10 rounded-full blur-[120px] animate-float" style={{ animationDelay: '2s' }}></div>
            ...
            <div className="w-full max-w-md relative z-10 perspective-1000">
                <div className="glass-card p-8 md:p-10 backdrop-blur-2xl bg-white/80 border border-white/60 shadow-2xl shadow-slate-200/50 rounded-[2.5rem] animate-in fade-in zoom-in-95 duration-500">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        {successMessage && (
                            <div className="bg-green-50 text-green-600 text-sm font-bold px-4 py-3 rounded-xl border border-green-100 flex items-center gap-2 animate-in slide-in-from-top-2">
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    Sign In <i className="fas fa-arrow-right group-hover:translate-x-1 transition-transform"></i>
                                </>
                            )}
                        </button>
                    </form>
