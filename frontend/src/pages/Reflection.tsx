    ...
    if (isSynthesizing) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 relative overflow-hidden">
                ...
                <h2 className="text-xl font-bold text-slate-800 animate-pulse">Saving to your private journal...</h2>
            </div>
        )
    }
    ...
    return (
        <div className="min-h-screen bg-slate-50/50 flex flex-col items-center justify-center py-10 px-6 relative">
            ...
            <header className="max-w-xl w-full text-center mb-10 relative z-10 animate-in fade-in slide-in-from-top-4 duration-700">
                <h1 className="text-3xl font-black text-slate-900 mb-2 tracking-tight">Reflection & Growth</h1>
                <p className="text-slate-500 font-medium">Breathe. This is a private space to meaningfuly process your experience.</p>
            </header>
                ...
                {step === 'questions' && (
                    <div className="space-y-6">
                        {REFLECTION_PROMPTS.map((prompt, idx) => (
                            <div
                                key={idx}
                                className="glass-card p-6 animate-in slide-in-from-bottom-8 duration-700 fade-in"
                        ...
                        <div className="flex justify-center pt-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
                            <button
